...
var nicEditorConfig = bkClass.extend({
    ...
    iconsPath: 'http://qm.v0.2.2.026.loc/appDoc/ViewsTheme/default/js/nicEditorIcons.gif',
...
nicEditor = nicEditor.extend({floatingPanel: function () {
...
var nicCodeButton = nicEditorAdvancedButton.extend({width: "700px", addPane: function () {
    this.addForm({"": {type: "title", txt: "Edit HTML"}, code: {type: "content", value: this.ne.selectedInstance.getContent(), style: {width: "690px", height: "450px"}}})
}, submit: function (B) {
