...
class BaseSiteController extends Controller{
   ...
   // }
    ...
    public function init()
    {
        ...
        //$this->setChunk('sidebarThird','chunks/sidebarQuickStart');
        ...
        /** jquery-2.0.3
        $this->registerScript(array(
            'path'  => PATH_APP_THEME.'js'.DS.'jquery-1.7.0.js',
            'name'  =>'jquery'
        ));*/

        /** nicEdit.js
        $this->registerScript(array(
            'path'  => PATH_APP_THEME.'js'.DS.'nicEdit.js',
            'name'  =>'nicEdit'
        ));*/

        /** script.js
        $this->registerScript(array(
            'path'  => PATH_APP_THEME.'js'.DS.'script.js',
            'name'  =>'themeScript'
        ));*/
